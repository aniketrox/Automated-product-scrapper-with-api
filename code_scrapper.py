...
proxy_data = pd.read_csv("proxy.csv")
...
main_url = 'https://codecanyon.net/category'
...
for link in main_div.find_all('a'):
    urls.append("https://codecanyon.net"+link.get('href')+"?sort=sales")
    
csv_file = 'codecanyon.csv'
